...
public:
    ...
    int earliestFinishTime(vector<int>& landStartTime, vector<int>& landDuration, vector<int>& waterStartTime, vector<int>& waterDuration) {
        int firstLand_thenWater = findFinishTime(landStartTime,landDuration,waterStartTime, waterDuration);
        int firstWater_thenLand = findFinishTime(waterStartTime,waterDuration,landStartTime,landDuration);
